...
Adaptive progressive photon mapping requires more than 100 million photons to converge to near the expected values of $0.72 \frac{W}{m^2}$ near the edges, although it does converge fairly well to $0.3 \frac{W}{m^2} $ near the middle of the interval. 
...
Adaptive photon mapping converges quickly, but does not attain as small of a mean squared error as the following Metropolis method. While the image quality is comparible, we can only hypothesize that the methods differ *****
