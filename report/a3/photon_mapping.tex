...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plots/adaptiveppm_gray_100000}\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plots/adaptiveppm_gray_1000000}\\
    \caption{Adaptive photon mapping, 1 million photons}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plots/adaptiveppm_gray_10000000}\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plots/adaptiveppm_gray_100000000}\\
